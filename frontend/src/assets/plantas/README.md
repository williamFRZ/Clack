...
A imagem inteira é exibida sem recorte. Os cartões de salas ficam abaixo da planta;
a sobreposição de áreas clicáveis será ajustada quando houver a planta real.
